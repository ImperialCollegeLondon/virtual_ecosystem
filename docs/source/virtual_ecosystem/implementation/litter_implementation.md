...
* <a href="./variables.html?models=litter&roles=vars_required_for_init">Variables
  required to initialise the litter model.</a>

<!-- markdownlint-disable-next-line MD033-->
* <a href="./variables.html?models=litter&roles=vars_required_for_update">Variables
  required to update the litter model.</a>

<!-- markdownlint-disable-next-line MD033-->
* <a href="./variables.html?models=litter&roles=vars_populated_by_init">Variables
  generated by litter model initialisation.</a>

<!-- markdownlint-disable-next-line MD033-->
* <a
  href="./variables.html?models=litter&roles=vars_populated_by_first_update">Variables
  generated by the first litter model update.</a>

<!-- markdownlint-disable-next-line MD033-->
* <a href="./variables.html?models=litter&roles=vars_updated">Variables updated by the
  litter model.</a>
