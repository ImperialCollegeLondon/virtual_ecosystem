...
fundamental physical laws to simulate [local radiation, energy, and carbon
balance](./microclimate_primer.md#balancing-energy-water-and-carbon) as well as
[local](./hydrology_primer.md#local-water-balance) and [catchment scale water cycle
dynamics](./hydrology_primer.md#catchment-scale-water-balance) to predict how
microclimatic conditions and hydrological processes interact and evolve over time.
