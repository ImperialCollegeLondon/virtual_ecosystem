...
model you wish to hold static entirely from the simulation configuration. In order to
get the other models to run, you will then have to provide as input data the variables
that other models used that were generated by the removed model.
```
