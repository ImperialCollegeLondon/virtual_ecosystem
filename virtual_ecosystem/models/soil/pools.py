...
from virtual_ecosystem.models.soil.env_factors import (
    ...
    find_total_soil_moisture_for_biotic_topsoil,
...
class SoilPools:
    ...
    def calculate_all_pool_updates(
        ...
        soil_moisture = find_total_soil_moisture_for_biotic_topsoil(
    ...
    def to_per_volume(
        ...
        if isinstance(input_rate, float):
            return np.array(input_rate / self.core_constants.biotic_topsoil_depth)
        else:
            return input_rate / self.core_constants.biotic_topsoil_depth
...
def calculate_free_living_nitrogen_fixation(
    ...
    # soil depth
    fixation_at_reference_volume = fixation_at_reference / biotic_topsoil_depth
