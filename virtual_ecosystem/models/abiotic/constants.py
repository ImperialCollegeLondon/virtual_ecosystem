...
class AbioticConsts(ConstantsDataclass):
    ...
    """Clumping factor."""
    leaf_reluctance_shortwave: float = 0.4
    """Leaf reluctance of shortwave radiation."""
    leaf_transmittance_shortwave: float = 0.2
    """Leaf transmittance of shortwave radiation."""
    leaf_reluctance_shortwave_par: float = 0.4
    """Leaf reluctance of photosynthetically active shortwave radiation."""
    leaf_transmittance_shortwave_par: float = 0.2
    """Leaf transmittance of photosynthetically active shortwave radiation."""
    leaf_dimension: float = 0.05
    """Leaf diemnaion."""
    leaf_emissivity: float = 0.97
    """Leaf emissivity."""
    maximum_stomatal_conductance: float = 0.3
    """Maximum stomatal conductance."""
    half_saturation_stomatal_conductance: float = 100.0
    """Half saturation point for stomatal conductance."""
    ...
    """Volumetric mineral content of soil."""
    volumetric_quartz_content: float = 0.06
    """Volumetric quartz content of soil."""
    mass_fraction_clay: float = 0.5
    """Mass fraction of clay in soil."""
    min_ground_heat_flux: float = 1000.0
    """Minimum ground heat flux, direction?"""
    max_ground_heat_flux: float = -1000.0
    """Maximum ground heat flux, direction?"""
    ...
    # The relative turbulence intensity is a proportionality factor that relates the
    # mean
    ...
    # across different heights or conditions. This factor is used to adjust wind
    # profiles
    ...
    # 419-425. TODO this is not representative of a rainforest environment and needs to
    # be
    # adjusted.
    # """
    ...
    # """Parameter in calculation of free conductance for positive temperature
    # difference
    # :cite:p:`campbell_introduction_2012`.
    # """

    # negative_free_conductance_parameter: float = 0.26
    # """Parameter in calculation of free conductance for negative temperature
    # difference
    # :cite:p:`campbell_introduction_2012`.
    # """
