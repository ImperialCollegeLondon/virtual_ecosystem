...
class HydrologyConfiguration(ModelConfigurationRoot):
    ...
    p_wet_wet: Annotated[float, Field(ge=0.3, le=0.8)] = 0.6
    """Probability a wet day follows a wet day."""
    p_wet_dry: Annotated[float, Field(ge=0.1, le=0.5)] = 0.3
    """Probability a wet day follows a dry day."""
    rainfall_shape_parameter: Annotated[float, Field(ge=0.7, le=4.0)] = 1.5
    """Shape parameter of the Gamma distribution controlling rainfall variability."""
    rainfall_scale_parameter: Annotated[float, Field(ge=0.1, le=2.0)] = 1.0
