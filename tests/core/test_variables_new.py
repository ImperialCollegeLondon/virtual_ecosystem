...
def fixture_variable():
    ...
    from virtual_ecosystem.core.variables_new import VariableMetadata
...
def test_VariablesFile():
    ...
    from virtual_ecosystem.core.variables_new import VariableMetadata, VariablesFile
...
def test_collect_vars_populated_by_init(fixture_variable, fixture_test_model):
    """Test the _collect_vars_populated_by_init function."""
    from virtual_ecosystem.core.variables_new import _collect_vars_populated_by_init
...
def test_collect_vars_updated(caplog, fixture_variable, fixture_test_model):
    ...
    from virtual_ecosystem.core.variables_new import _collect_vars_updated
...
def test_collect_vars_required_for_update(fixture_variable, fixture_test_model):
    ...
    from virtual_ecosystem.core.variables_new import _collect_vars_required_for_update
...
def test_collect_vars_required_for_init(fixture_variable, fixture_test_model):
    ...
    from virtual_ecosystem.core.variables_new import _collect_vars_required_for_init
...
def test_collect_initial_data_vars(fixture_variable, fixture_test_model):
    ...
    from virtual_ecosystem.core.variables_new import _collect_initial_data_vars
...
def test_setup_variables(mocker, fixture_variable, fixture_test_model):
    """Test the _collect_initial_data_vars function."""
    from virtual_ecosystem.core import variables_new

    mocker.patch("virtual_ecosystem.core.variables_new._collect_initial_data_vars")
    mocker.patch("virtual_ecosystem.core.variables_new._collect_vars_populated_by_init")
    mocker.patch(
        "virtual_ecosystem.core.variables_new._collect_vars_populated_by_first_update"
    )
    mocker.patch("virtual_ecosystem.core.variables_new._collect_vars_required_for_init")
    mocker.patch("virtual_ecosystem.core.variables_new._collect_vars_updated")
    mocker.patch(
        "virtual_ecosystem.core.variables_new._collect_vars_required_for_update"
    )

    variables_new.setup_variables(
        [fixture_test_model],
        ["test_var"],
        known_variables={"test_var": fixture_variable},
    )

    variables_new._collect_initial_data_vars.assert_called_once_with(
        vars=["test_var"],
        known_variables={"test_var": fixture_variable},
        runtime_variables={},
    )
    variables_new._collect_vars_populated_by_init.assert_called_once_with(
        models=[fixture_test_model],
        known_variables={"test_var": fixture_variable},
        runtime_variables={},
    )

    variables_new._collect_vars_populated_by_first_update.assert_called_once_with(
        models=[fixture_test_model],
        known_variables={"test_var": fixture_variable},
        runtime_variables={},
    )
    variables_new._collect_vars_required_for_init.assert_called_once_with(
        models=[fixture_test_model],
        runtime_variables={},
    )
    variables_new._collect_vars_updated.assert_called_once_with(
        models=[fixture_test_model],
        runtime_variables={},
    )
    variables_new._collect_vars_required_for_update.assert_called_once_with(
        models=[fixture_test_model],
        runtime_variables={},
    )
...
def test_get_model_order():
    ...
    from virtual_ecosystem.core.variables_new import VariableMetadata, get_model_order
