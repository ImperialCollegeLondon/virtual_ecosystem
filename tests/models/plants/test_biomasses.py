...
def test_FoliageTissue_from_pft_default_ratios(fixture_community, extra_pft_traits):
    """Test the default factory method generates a tissue with the correct masses."""

    from virtual_ecosystem.models.plants.biomasses import FoliageTissue

    tissue = FoliageTissue.from_pft_default_ratios(
        community=fixture_community,
