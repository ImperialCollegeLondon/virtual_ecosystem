...
def test_setup(
    ...
    with (
        ...
        with raises:
            ...
            expected_2d = {
                "soil_moisture": [
                    [155.101465, 155.174751, 155.131158, 154.908996],
                    [212.63177, 212.656182, 212.627568, 212.619134],
                ],
                "matric_potential": [
                    [-32289.354831, -32604.360158, -32009.316202, -32441.821371],
                    [-1120.87137, -1119.854551, -1121.096939, -1121.483706],
                ],
            }
            ...
            expected_1d = {
                "vertical_flow": [0.981254, 0.983569, 0.983549, 0.980608],
                "total_river_discharge": [0, 0, 64223, 21291],
                "surface_runoff": [0, 0, 0, 0],
                "surface_runoff_accumulated": [0, 0, 0, 0],
                "soil_evaporation": [253.803321, 253.817719, 253.888223, 253.534049],
            }
