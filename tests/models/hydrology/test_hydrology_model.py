...
def test_setup(
    ...
    with (
        ...
        with raises:
            ...
            expected_2d = {
                "soil_moisture": [
                    [282.765245, 282.976805, 282.726526, 282.506466],
                    [218.99538, 218.995379, 218.995379, 218.99538],
                ],
                "matric_potential": [
                    [-137.861292, -137.661626, -137.902271, -138.088699],
                    [-209.681368, -209.681368, -209.681368, -209.681368],
                ],
            }
            ...
            expected_1d = {
                "vertical_flow": [0.000546, 0.000493, 0.000494, 0.000561],
