...
def test_setup(
    ...
    with (
        ...
        with raises:
            ...
            expected_2d = {
                "soil_moisture": [
                    [147.886087, 147.95408, 147.91522, 147.702386],
                    [212.303559, 212.326072, 212.300421, 212.292817],
                ],
                "matric_potential": [
                    [-55789.644573, -56421.005332, -55287.012269, -55989.890226],
                    [-1136.837407, -1135.892825, -1137.020868, -1137.356458],
                ],
            }
            ...
            expected_1d = {
                "vertical_flow": [0.970433, 0.972701, 0.972681, 0.9698],
                "total_river_discharge": [0, 0, 64183, 21280],
                "surface_runoff": [0, 0, 0, 0],
                "surface_runoff_accumulated": [0, 0, 0, 0],
                "soil_evaporation": [265.027838, 265.030236, 265.131078, 264.73263],
            }
