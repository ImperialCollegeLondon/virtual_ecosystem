...
def test_update(fixture_litter_model, dummy_litter_data):
    ...
    expected_output = {
        "litter_pool_above_metabolic_cnp": np.stack(
            [
                [0.31292595, 0.14770697, 0.07847683, 0.0711434],
                [0.04163379, 0.01683401, 0.00720338, 0.00710423],
                [0.00513777, 0.00212727, 0.00071441, 0.00072062],
            ],
            axis=1,
        ),
        "litter_pool_above_structural_cnp": np.stack(
            [
                [0.50477332, 0.24963641, 0.10312206, 0.11934793],
                [0.01340711, 0.00576873, 0.00208167, 0.0022817],
                [0.00148339, 0.00052651, 0.00022537, 0.00023008],
            ],
            axis=1,
        ),
        ...
        "litter_mineralisation_rate_cnp": np.stack(
            [
                [0.02666704, 0.02020936, 0.0075679, 0.00760406],
                [0.00600376, 0.00376086, 0.00087329, 0.00092879],
                [4.464663e-4, 2.122694e-4, 6.649138e-5, 6.665819e-5],
            ],
            axis=1,
        ),
    }
