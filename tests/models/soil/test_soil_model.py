    ...
    argvalues=[
        pytest.param(
            ...
            Dataset(
                data_vars=dict(
                    lmwc=DataArray(
                        [0.15063177, 0.31002327, 0.55051584, 0.01720028], dims="cell_id"
                    ),
                    maom=DataArray(
                        [2.54628534, 1.71355173, 4.30920135, 0.50159737], dims="cell_id"
                    ),
                    microbe=DataArray(
                        [5.72586017, 2.27814961, 11.21155052, 0.99495516],
                        dims="cell_id",
                    ),
                    pom=DataArray(
                        [0.02795836, 0.71862289, 0.52832504, 0.34396029], dims="cell_id"
                    ),
