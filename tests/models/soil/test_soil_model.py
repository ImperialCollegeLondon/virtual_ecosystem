            ...
            Dataset(
                data_vars=dict(
                    ...
                    soil_n_pool_don=DataArray(
                        [0.00100858, 0.00290725, 0.00221685, 0.00388335], dims="cell_id"
                    ),
                    ...
                    soil_n_pool_maom=DataArray(
                        [0.8669704, 0.48606318, 0.3342412, 0.09935354], dims="cell_id"
                    ),
                )
            ),
            (),
