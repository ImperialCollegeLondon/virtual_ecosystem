            ...
            Dataset(
                data_vars=dict(
                    soil_c_pool_lmwc=DataArray(
                        [0.1071862, 0.0423321, 0.21607749, 0.02032358], dims="cell_id"
                    ),
                    soil_c_pool_maom=DataArray(
                        [2.52014784, 1.71110374, 4.53414533, 0.53209146], dims="cell_id"
                    ),
                    ...
                    soil_c_pool_pom=DataArray(
                        [0.10088826, 0.99607827, 0.69401859, 0.35272508], dims="cell_id"
                    ),
                    soil_c_pool_necromass=DataArray(
                        [0.06200222, 0.05221195, 0.11560305, 0.08195386], dims="cell_id"
                    ),
                    ...
                    soil_n_pool_don=DataArray(
                        [0.00139499, 0.00326729, 0.00282836, 0.00394134], dims="cell_id"
                    ),
                    ...
                    soil_n_pool_maom=DataArray(
                        [0.86681771, 0.48672751, 0.33433377, 0.09972465], dims="cell_id"
                    ),
                    soil_n_pool_ammonium=DataArray(
                        [0.00042707, 0.01507419, 0.00036006, 0.00524337], dims="cell_id"
                    ),
                    ...
                    soil_p_pool_dop=DataArray(
                        [0.00017432, 0.00012877, 0.00032988, 0.00018242], dims="cell_id"
                    ),
                    soil_p_pool_particulate=DataArray(
                        [3.21780215e-5, 2.85147942e-4, 1.14676885e-4, 5.71721209e-4],
                        dims="cell_id",
                    ),
                    soil_p_pool_necromass=DataArray(
                        [0.0019653, 0.00148671, 0.00366575, 0.00078505], dims="cell_id"
                    ),
                    soil_p_pool_maom=DataArray(
                        [0.01356918, 0.0348899, 0.02001952, 0.00406409], dims="cell_id"
                    ),
                    ...
                    soil_p_pool_labile=DataArray(
                        [-6.41626267e-6, -1.18580657e-4, 9.71526744e-7, 1.91353093e-4],
                        dims="cell_id",
                    ),
                )
            ),
