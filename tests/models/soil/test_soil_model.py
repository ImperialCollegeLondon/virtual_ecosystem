    ...
    argvalues=[
        pytest.param(
            ...
            Dataset(
                data_vars=dict(
                    lmwc=DataArray(
                        [0.0549357, 0.02698085, 0.23853806, 0.005455], dims="cell_id"
                    ),
                    maom=DataArray(
                        [2.49735024, 1.69906323, 4.37846968, 0.50002228], dims="cell_id"
                    ),
                    microbe=DataArray(
                        [5.77450159, 2.28927686, 11.24362854, 0.99640422],
                        dims="cell_id",
                    ),
                    pom=DataArray(
