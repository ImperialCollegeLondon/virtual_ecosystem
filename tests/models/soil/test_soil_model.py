    ...
    argvalues=[
        pytest.param(
            ...
            Dataset(
                data_vars=dict(
                    lmwc=DataArray(
                        [0.04677861, 0.01911956, 0.08970521, 0.00498285], dims="cell_id"
                    ),
                    maom=DataArray(
                        [2.56833002, 1.73404228, 4.65576973, 0.50264192], dims="cell_id"
                    ),
                    microbe=DataArray(
                        [5.63673101, 2.2178081, 10.93023408, 0.99357027],
                        dims="cell_id",
                    ),
                )
            ),
