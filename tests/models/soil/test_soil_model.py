            ...
            Dataset(
                data_vars=dict(
                    soil_cnp_pool_maom=DataArray(
                        data=np.stack(
                            [
                                [2.5194, 1.70929, 4.53482, 0.537921],
                                [0.866529, 0.486043, 0.334007, 0.100018],
                                [0.0135186, 0.0348096, 0.0199066, 0.00410605],
                            ],
                            axis=1,
                        ),
                    ...
                    soil_cnp_pool_lmwc=DataArray(
                        data=np.stack(
                            [
                                [0.123868, 0.405729, 0.230283, 0.039283],
                                [0.00156127, 0.0043592, 0.00307804, 0.00524098],
                                [0.000173742, 0.000130573, 0.000267522, 0.000273113],
                            ],
                            axis=1,
                        ),
                        coords={"cell_id": np.arange(0, 4), "element": ["C", "N", "P"]},
                    ...
                    soil_cnp_pool_pom=DataArray(
                        data=np.stack(
                            [
                                [0.0960789, 0.982734, 0.686626, 0.349011],
                                [0.00709874, 0.000739641, 0.00290216, 0.0142883],
                                [3.1959e-5, 0.000282518, 0.000113849, 0.000571509],
                            ],
                            axis=1,
                        ),
                        coords={"cell_id": np.arange(0, 4), "element": ["C", "N", "P"]},
                    ...
                    soil_cnp_pool_necromass=DataArray(
                        data=np.stack(
                            [
                                [0.0603134, 0.0511194, 0.127183, 0.113193],
                                [0.00582752, 0.017122, 0.0221619, 0.0111466],
                                [0.00170676, 0.00124253, 0.00309618, 0.00100997],
                            ],
                            axis=1,
                        ),
                        coords={"cell_id": np.arange(0, 4), "element": ["C", "N", "P"]},
                    ...
                    soil_c_pool_bacteria=DataArray(
                        [5.77597751, 2.29138936, 11.25612392, 0.99661243],
                        dims="cell_id",
                    ),
                    soil_c_pool_saprotrophic_fungi=DataArray(
                        [0.88651672, 8.51879071, 2.20165691, 4.52530902], dims="cell_id"
                    ),
                    soil_c_pool_arbuscular_mycorrhiza=DataArray(
                        [0.64753324, 1.46473434, 3.90595742, 9.01253176], dims="cell_id"
                    ),
                    soil_c_pool_ectomycorrhiza=DataArray(
                        [0.46785899, 1.3152269, 4.18439615, 3.75805994], dims="cell_id"
                    ),
                    soil_enzyme_pom_bacteria=DataArray(
                        [0.02240916, 0.0094625, 0.04945816, 0.00297424], dims="cell_id"
                    ),
                    soil_enzyme_maom_bacteria=DataArray(
                        [0.03517603, 0.01156117, 0.0247949, 0.00450575], dims="cell_id"
                    ),
                    soil_enzyme_pom_fungi=DataArray(
                        [0.02576036, 0.00569584, 0.00640515, 0.00436985], dims="cell_id"
                    ),
                    soil_enzyme_maom_fungi=DataArray(
                        [0.00856692, 0.00675901, 0.00378379, 0.00214966], dims="cell_id"
                    ),
                    soil_n_pool_ammonium=DataArray(
                        [0.00016956, 0.01009215, 0.00023244, 0.00488504], dims="cell_id"
                    ),
                    soil_n_pool_nitrate=DataArray(
                        [-0.00093326, -0.00049614, -0.00063784, 0.01256526],
                        dims="cell_id",
                    ),
                    ...
                    soil_p_pool_labile=DataArray(
                        [2.40213876e-6, -1.65099940e-4, 3.11226986e-5, 1.76281005e-4],
                        dims="cell_id",
                    ),
                    cnp_fungal_fruiting_body_production=DataArray(
                        data=np.stack(
                            [
                                [1.8671e-5, 0.000216582, 0.000299808, 0.000231214],
                                [1.50525e-6, 2.41726e-5, 2.03315e-5, 1.51213e-5],
                                [2.34944e-7, 3.86341e-6, 3.12163e-6, 2.31273e-6],
                            ],
                            axis=1,
                        ),
                        coords={"cell_id": np.arange(0, 4), "element": ["C", "N", "P"]},
                    ...
                    new_amf_n_supply=DataArray(
                        [1.28666931e-6, 7.85737946e-6, 2.44569238e-5, 2.31007553e-5],
                        dims="cell_id",
                    ),
                    new_amf_p_supply=DataArray(
                        [1.93000396e-7, 1.17860692e-6, 3.66853857e-6, 3.46511329e-6],
                        dims="cell_id",
                    ),
                    new_emf_n_supply=DataArray(
                        [9.22871190e-7, 7.00210300e-6, 1.72085619e-5, 9.56029482e-6],
                        dims="cell_id",
                    ),
                    new_emf_p_supply=DataArray(
                        [1.39486058e-7, 1.05832294e-6, 2.60096371e-6, 1.44497722e-6],
                        dims="cell_id",
                    ),
                ),
            ),
