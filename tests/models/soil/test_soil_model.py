            ...
            Dataset(
                data_vars=dict(
                    soil_c_pool_lmwc=DataArray(
                        [0.05655836, 0.02322489, 0.11935823, 0.01485682], dims="cell_id"
                    ),
