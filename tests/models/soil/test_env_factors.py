...
def test_find_total_soil_moisture_for_biotic_topsoil(
    ...
    actual_soil_moisture = find_total_soil_moisture_for_biotic_topsoil(
...
def test_find_water_outflow_rates(
    ...
    if increased_depth:
        ...
        fixture_core_components.layer_structure.biotic_topsoil_depth = 0.70
